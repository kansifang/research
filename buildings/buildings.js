var OSMBuildings = (function (global) {
    ...
    function B() {
		...
		*/
		...
		// 根据URL或数据对象获取JSON数据对象
        function geoJSON(url, isLatLon) {
            if (typeof url === 'object') {// 如果传入JSON数据对象，则直接设置数据
        ...
        var mapOnMove, mapOnMoveEnd, mapOnZoomEnd, blockMoveEvent; // needed as Leaflet fires moveend and zoomend together
