...
function canvasApp() {
    ...
    //样式
    subwayline.style = { strokeStyle: "#1C8607", lineWidth: 6, theme: { type: "uniqueTheme",field:"lineid", values: { 1: { strokeStyle: "#BE3830" }, 2: { strokeStyle: "#0E6099" },
        4: { strokeStyle: "#008F9D" }, 5: { strokeStyle: "#A81D80" }, 13: { strokeStyle: "#F4E80D" }, 18: { strokeStyle: "#BE3830" }, 10: { strokeStyle: "#0699C4" }, 21: { strokeStyle: "#A29ABF" },
        22: { strokeStyle: "#A29ABF" }, 8: { strokeStyle: "#009E6C" }, 9: { strokeStyle: "#DC0074" }, 14: { strokeStyle: "#E183B5" },15: { strokeStyle: "#6B337E" }  
    }
    }
};
    subwaypoint.style = { fillStyle: "#FFFFFF", strokeStyle: "#DE0006",radius:3.5,labelField:"value",labelColor:"#000000",labelMinScale:120000};
