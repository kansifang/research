...
(function () {
    ...
    var MercatorProjection = function a7() {}
    ...
    var PerspectiveProjection = function cB() {}
    ...
    var InfoWindow = function bM(cJ, cI) {
        bmap.lang.Class.call(this);
        this.content = cJ;
        this.map = null;
        this._config = {
    ...
    var Geolocation = function ai(cI) {
        this._opts = {};
        bmap.extend(this._opts, cI);
        this._queryList = [];
        var T = this;
