...
function d(a, b) {
    var c;
    ab(a.childNodes,
    function(d) { (c = d.getAttribute(dc)) && c != b && a.removeChild(d)
    })
}
function j(a, b, c, d) {
    var e = null;
    ab(a.childNodes,
    function(a) {
        if ((!d || "tag" === a.nodeName) && (!c || a.className === c) && a.getAttribute(dc) == b) return e = a,
        !1
    });
    return e
}
...
function fa(a) {
    ...
    function(c) {
        new c(b, a)
    }) : document.body.addEventListener ? B.$require("e1",
    function(c) {
        new c(b, a)
    }) : B.$require("e2",
    function(c) {
...
cb = function(a) {
    ...
    d = ["<object", fb];
    a.data = a.movie;
    for (b = 0; b < Ua.length; b++) c = Ua[b],
    a.hasOwnProperty(c) && d.push(" ", c, '="', a[c], '"');
    d.push(">");
    for (b = 0; b < Za.length; b++) c = Za[b],
    a.hasOwnProperty(c) && d.push('<param name="', c, '" value="', a[c], '"/>');
    d.push("</object>");
    return d.join("")
},
Ma = function(a, b) {
...
db = function(a, b) {
    var c, d, e = !1;
    c = 0;
    for (d = ub.length; c < d; ++c) if (ub[c].url === a) return b(ub[c].width, ub[c].height, a, ub[c].image),
    ub[c].image;
    c = 0;
...
oc = function(a, b, d, e, g, p, j) {
    ...
    if (b) {
        ...
        a.style.overflow = "hidden"; ! e || p ? db(b,
        function(d, e) {
...
V.prototype.loadImage = function(a, b, c) {
    ...
    if (d && d.cancelled) d.cancelled = !1,
    d.callback = b,
    d.force = c;
    else {
        d = new va(a, b, c);
        if (b = this.cors) a = Wb.exec(a),
        b = (a && a[1]) !== this._domain;
        b && (d.crossOrigin = !0);
...
sc = function(a) {
    ...
    e = a.offsetWidth,
    g = a.offsetHeight;
    if (a.getBoundingClientRect && !Rb) b = a.getBoundingClientRect(),
    ...
    d = b.top + a;
        ...
        d = b.y - d;
            ...
            d += b.offsetTop,
            b = b.offsetParent;
            if (Me || mb && "absolute" == a.style.position) c -= document.body.offsetLeft,
...
r.triggerEvents = function(a, b, c) {
    var d = this._model;
    if (d) {
        if (kd(b)) for (var e = new fa(b), g = this, j = 0, p = a.length; j < p; j++) e.addListener(a[j],
        function(a, b) {
            return function(c) {
...
r.forwardEvents = function(a) {
    ...
    if (b) {
        ...
        for (var c = 0,
        d = a.length; c < d; c++) Ob.forward(b._eventTaget, a[c], this)
    }
};
r.getMouseEventLatLng = function(a, b) {
    var c = this._model;
    if (c && (c = c.get("map") || c)) return b = b || this.getMouseContainerPixel(a),
    (c = c.get("mapCanvasProjection")) && c.fromContainerPixelToLatLng(b, null, !0)
};
...
r.getMouseContainerPixel = function(a) {
    var b = this._model;
    if (b) return b = (b.get("map") || b).get("mapContainer"),
    b = sc(b),
    a = rc(a),
    new x(a[0] - b[0], a[1] - b[1])
};
r.getModel = function() {
    return this._model
};
...
r.keysUnReady = function(a, b, c) {
    ...
    function(a, b) {
        ...
        function(a, e) {
            var j;
            if (c && ea(j = c(a, b[e])) ? j: g(a) || tc(a)) return d = !0,
            !1
        });
        return d
    })
