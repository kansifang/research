(function () {
    ...
    function rf() {
		...
		sf("./v2.0/modules.php?m="+a.join());
		/*
        for (var a = kf(a), b = a.length; b--;){
			sf(a[b]);
		}
		*/
		//for (var b = a.length; b--;) sf("v2.0/src/" + a[b]+ ".js");
    }
    function x(a, b) {
        this.x = a;
        this.y = b
    ...
    var qa = ["v2", "", "../src/", "../src/theme/", 1, 18, 39.9165275426627, 116.39712896958922, 256, 6378136.49, /*DEBUG*/1, new Date, !1, !1, "http://sv.map.soso.com/xf", "http://sv.map.soso.com/web_cfg", null, "http://api.map.qq.com/", "http://ping.map.soso.com/stats"],
